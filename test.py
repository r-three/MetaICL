...
def main(logger, args):
    ...
    metaicl_model = MetaICLModel(args.model_name)
    ...
    metaicl_data = MetaICLData(
        logger, tokenizer, args.method, args.use_demonstrations, args.k, max_length, max_length_per_example
    )
...
def run(logger, task, metaicl_data, metaicl_model, train_data, dev_data, seed, is_classification, add_newlines=True):
